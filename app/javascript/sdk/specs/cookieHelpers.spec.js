...
describe('#getUserCookieName', () => {
  it('returns correct cookie name', () => {
    global.$chatquick = { websiteToken: '123456' };
...
describe('#getUserString', () => {
  it('returns correct user string', () => {
    expect(
      getUserString({
        user: {
          ...
          avatar_url: 'https://images.quicksales.vn/placeholder',
          identifier_hash: '12345',
        },
        identifier: '12345',
      })
    ).toBe(
      'avatar_urlhttps://images.quicksales.vn/placeholderemailpranav@example.comnamePranavidentifier_hash12345identifier12345'
    );
    ...
    expect(
      ...
      'avatar_urlhttps://images.quicksales.vn/placeholderemailpranav@example.comnameidentifier_hashidentifier'
    );
  });
});
