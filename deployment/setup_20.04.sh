...
# Description: Install and manage a Chatquick installation.
# OS: Ubuntu 20.04 LTS
...
serve Chatquick at https://$domain_name.
...
##############################################################################
# Setup Chatquick systemd services and cwctl CLI
# Globals:
#   None
# Arguments:
#   None
...
***************************************************************************
Woot! Woot!! Chatquick server installation is complete.
...
function cwctl_message() {
  echo $'\U0001F680 Try out the all new Chatquick CLI tool to manage your installation.'
...
function get_cw_version() {
  CW_VERSION=$(curl -s https://chat.quicksales.vn/api | python3 -c 'import sys,json;data=json.loads(sys.stdin.read()); print(data["version"])')
}
...
***************************************************************************
              Chatquick Installation (v$CW_VERSION)
***************************************************************************
...
EOF
  ...
  sleep 3
  read -rp 'Would you like to configure a domain and SSL for Chatquick?(yes or no): ' configure_webserver
...
function help() {
  ...
  cat <<EOF
Usage: cwctl [OPTION]...
Install and manage your Chatquick installation.
...
Installation/Upgrade:
  -i, --install             Install the latest stable version of Chatquick
  -I                        Install Chatquick from a git branch
  -u, --upgrade             Upgrade Chatquick to the latest stable version
...
Management:
  ...
  -l, --logs                View logs from Chatquick. Supported values include web/worker.
  -r, --restart             Restart Chatquick server
...
##############################################################################
# Get Chatquick web/worker logs (-l/--logs)
# Globals:
#   None
# Arguments:
#   None
...
##############################################################################
# Restart Chatquick server (-r/--restart)
# Globals:
#   None
# Arguments:
#   None
